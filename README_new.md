...
Так называемые "Основные правила" - самый простой вид правил. Эти правила предназначены для блокировки запросов на определенный URL. 
...
* modifiers - Параметры, используемые для "уточнения" общего правила. Перед параметром должен стоять символ "$".
