...
Позволяет бловировать загрузку css-стилей. 

#### Examples

 * `||example.com$stylesheet` будет блокировать загрузку всех стилей на домене `example.com.`
 * `@@||exmple.com$stylesheet` наоборот, разблокирует загрузку заблокированных другими правилами стилей.
...
Представим, что на домене `example.com` расположен интернет магазин, и одним из правил нарушена работа фильтров в этом магазине. 
Правило `@@||example.com^*$xmlhttprequest` позволит восстановить корректную работу сайта в таком случае.
