...
<ul>
	...
	<li>
		<tt>xmlhttrequest - блокирует xmlhttpsrequest-запрос (запрос, который браузер загружает без обновления страницы). Такими запросами зачастую пользуются интернет-магазины при применении выбранных вами фильтров. 
